...
namespace Shelvance.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open Shelvance in a browser", StartupContext.NO_BROWSER);
            Console.WriteLine("                 /{0} Start Shelvance terminating any other instances", StartupContext.TERMINATE);
