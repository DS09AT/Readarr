...
namespace Shelvance.Common.EnvironmentInfo
{
    ...
    public class AppFolderFactory : IAppFolderFactory
    {
        ...
        public void Register()
        {
            ...
            {
                throw new ShelvanceStartupException("Cannot create AppFolder, Access to the path {0} is denied", _appFolderInfo.AppDataFolder);
            }
            ...
            {
                throw new ShelvanceStartupException("AppFolder {0} is not writable", _appFolderInfo.AppDataFolder);
            }
