...
namespace Shelvance.Core.Test.MediaFiles.BookImport.Identification
{
    ...
    public class IdentificationServiceFixture : DbTest
    {
        ...
        public void SetUp()
        {
            ...
            Mocker.SetConstant<IProvideAuthorInfo>(Mocker.Resolve<MetadataAggregationService>());
            Mocker.SetConstant<IProvideBookInfo>(Mocker.Resolve<MetadataAggregationService>());
