...
namespace Shelvance.Core.Indexers.TorrentRss
{
    ...
    public class TorrentRssIndexerSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(3, Type = FieldType.Number, Label = "Early Download Limit", Unit = "days", HelpText = "Time before release date Shelvance will download from this indexer, empty is no limit", Advanced = true)]
