...
namespace Shelvance.Core.HealthCheck.Checks
{
    ...
    public class IndexerRssCheck : HealthCheckBase
    {
        ...
        public override HealthCheck Check()
        {
            ...
            if (enabled.Empty())
            {
                return new HealthCheck(GetType(), HealthCheckResult.Error, _localizationService.GetLocalizedString("IndexerRssHealthCheckNoIndexers"), "#no-indexers-available-with-rss-sync-enabled-shelvance-will-not-grab-new-releases-automatically");
            }
