...
namespace Shelvance.Core.Download.Clients.Flood
{
    public class Flood : TorrentClientBase<FloodSettings>
    {
        ...
        public override ProviderMessage Message => new ProviderMessage("Shelvance will handle automatic removal of torrents based on the current seed criteria in Settings -> Indexers", ProviderMessageType.Info);
