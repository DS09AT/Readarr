...
namespace Shelvance.Core.Notifications
{
          ...
          IHandle<UpdateInstalledEvent>
    {
        ...
        {
            return string.Format("Shelvance failed to Import all files for {0}",
                source);
        }
        ...
        public void Handle(UpdateInstalledEvent message)
        {
            ...
            updateMessage.Message = $"Shelvance updated from {message.PreviousVerison.ToString()} to {message.NewVersion.ToString()}";
