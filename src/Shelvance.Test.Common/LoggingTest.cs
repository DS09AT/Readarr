...
namespace Shelvance.Test.Common
{
    ...
    {
        protected static readonly Logger TestLogger = ShelvanceLogger.GetLogger("TestLogger");
        ...
        protected static void InitLogging()
        {
            ...
            if (LogManager.Configuration == null || LogManager.Configuration.AllTargets.None(c => c is ExceptionVerification))
            {
                ...
                Enum.TryParse<TestLogOutput>(Environment.GetEnvironmentVariable("SHELVANCE_TESTS_LOG_OUTPUT"), out var logOutput);
