...
module.exports = {
  ...
  menuItemHoverColor: shelvanceRed,
  menuItemHoverBackgroundColor: '#606060',

  //
  // Toolbar

  toobarButtonHoverColor: shelvanceRed,
  toobarButtonSelectedColor: shelvanceRed,
