...
function SocialLink({ href, icon: Icon, children }: SocialLinkProps) {
  return (
...
function PageNavigation() {
  // This would be populated based on your actual navigation structure
  // For now, returning null as we don't have multiple pages yet
  // When implemented, use PageLink component for Previous/Next navigation
  return null;
}
